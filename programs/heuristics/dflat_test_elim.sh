...
dflat2 -s dummy -e $8 --graphml-out g.inp.$pid -f $1 --print-decomposition $3                        --no-empty-root --no-empty-leaves -n semi --elimination min-degree #--path-decomposition
dflat2 -s dummy -e $8 --graphml-out g.xml.$7.$pid -f $1 --print-decomposition $3                        --no-empty-root --no-empty-leaves -n semi --elimination min-degree #--path-decomposition
echo "DFLAT done"
echo "DFLAT2ASPing..."
