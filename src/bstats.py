                        ...
                        try:
                            ...
                            try:
                                if irr.measures['status'][1] != status_max[2]:
                                    if (dic_name_conf.get("presolved") is not None and irr.measures.get(
...
if __name__ == '__main__':
    ...
    parser.add_option("--status", dest="status", action="store", default="",
                      help="print only 0:'SATISFIABLE', 1:'UNSATISFIABLE' or 2:'UNKNOWN instances")
